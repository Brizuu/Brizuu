...
|---|---|---|
| [Terra#](https://github.com/Brizuu/TerraHash) | Optimized Minecraft terrain plugin for BuildTheEarth Poland (10k+ community) | Java |
| [JobForge](https://github.com/Brizuu/JobForge) | REST API platform for job offers, internships & courses | ASP.NET Core, PostgreSQL, Docker |

---

### 🛠 Tech Stack

**Backend:** C# · ASP.NET Core · Java · MySQL · PostgreSQL  
**Frontend:** React · JavaScript · Tailwind CSS · SCSS  
